/*
  ...
  - You are about to drop the `meal_replacement` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "public"."Meal" DROP CONSTRAINT "Meal_periodId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Period" DROP CONSTRAINT "Period_dietId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Workout" DROP CONSTRAINT "Workout_memberId_fkey";

-- DropForeignKey
ALTER TABLE "public"."meal_replacement" DROP CONSTRAINT "meal_replacement_foodId_fkey";

-- DropForeignKey
ALTER TABLE "public"."meal_replacement" DROP CONSTRAINT "meal_replacement_mealId_fkey";
...
-- DropTable
DROP TABLE "public"."meal_replacement";
...
-- CreateTable
CREATE TABLE "meal_replacement" (
    "id" TEXT NOT NULL,
    "foodId" TEXT NOT NULL,
    "mealId" TEXT NOT NULL,
    "quantity" TEXT NOT NULL,

    CONSTRAINT "meal_replacement_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Period" ADD CONSTRAINT "Period_dietId_fkey" FOREIGN KEY ("dietId") REFERENCES "Diet"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Meal" ADD CONSTRAINT "Meal_periodId_fkey" FOREIGN KEY ("periodId") REFERENCES "Period"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "meal_replacement" ADD CONSTRAINT "meal_replacement_foodId_fkey" FOREIGN KEY ("foodId") REFERENCES "Food"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "meal_replacement" ADD CONSTRAINT "meal_replacement_mealId_fkey" FOREIGN KEY ("mealId") REFERENCES "Meal"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
